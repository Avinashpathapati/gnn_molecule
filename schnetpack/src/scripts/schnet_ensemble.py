...
def main(args):
	...
	sch_model_2 = torch.load(os.path.join('/home/s3754715/gnn_molecule/schnetpack/model_2020-07-29-12-59-15', 'best_model'))
	sch_model_3 = torch.load(os.path.join('/home/s3754715/gnn_molecule/schnetpack/model_2020-07-29-19-37-30', 'best_model'))
	...
	for count, batch in enumerate(test_loader):
		    ...
		    tmp = torch.sum(torch.abs(torch.mean(torch.cat([pred_1[args.property], pred_2[args.property], pred_3[args.property]],dim=1), dim=1).unsqueeze(dim=1)-batch[args.property]))
